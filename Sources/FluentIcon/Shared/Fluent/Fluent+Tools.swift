...
public extension Fluent {
	...
	func asImage(size: CGSize, color: Color = Color.black, backgroundColor: Color = Color.clear) -> Fluent.Image {
	...
	func asImage(size: CGFloat, color: Color = Color.black, backgroundColor: Color = Color.clear) -> Fluent.Image {
...
public extension Fluent {
	...
	var image: FluentIcon.Image<Self> {
